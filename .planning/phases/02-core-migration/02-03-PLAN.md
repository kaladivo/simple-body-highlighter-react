...
- `grep -r "colors:" src/index.tsx` should find nothing
  ...
  <done>
Body component refactored with simplified API. Uses ModelProps type. onClick callback with slug. No intensity system. No colors array. No onBodyPartPress. TypeScript compiles. Build succeeds.
  </done>
</task>
...
Type declarations contain new types, not old types.
  ...
  <done>
Build produces clean output with new API. Type declarations export BodyPartSlug, BodyPartData, ModelProps. Old types removed. ESM and CJS imports work.
  </done>
</task>
...
4. dist/index.d.ts exports new types only
5. ESM import test works
6. CJS import test works
</verification>
