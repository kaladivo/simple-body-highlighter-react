...
1. **BodyPartSlug** - Union type of all valid body part slugs:
   - Bilateral muscles (18 pairs = 36 slugs): left-adductors, right-adductors, left-ankles, right-ankles, left-biceps, right-biceps, left-calves, right-calves, left-chest, right-chest, left-deltoids, right-deltoids, left-feet, right-feet, left-forearm, right-forearm, left-gluteal, right-gluteal, left-hamstring, right-hamstring, left-hands, right-hands, left-knees, right-knees, left-obliques, right-obliques, left-quadriceps, right-quadriceps, left-tibialis, right-tibialis, left-trapezius, right-trapezius, left-triceps, right-triceps, left-upper-back, right-upper-back, left-lower-back, right-lower-back
   - Centerline muscles (6 slugs): abs, head, hair, neck, lower-back, upper-back

   NOTE: chest has left/right paths in the SVG assets (see src/assets/bodyFront.ts lines 8-16), so it is bilateral, not centerline. Similarly, upper-back and lower-back have left/right in back view.
...
Verify file contains all 42 slugs (36 bilateral + 6 centerline).
  </verify>
  <done>
src/types.ts exists with BodyPartSlug (42 values), BodyPartData, and ModelProps types. All types have JSDoc comments. TypeScript compiles without errors.
  </done>
</task>
...
- BodyPartSlug contains 42 values (36 bilateral + 6 centerline)
